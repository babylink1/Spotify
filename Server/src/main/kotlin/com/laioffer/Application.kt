...
fun Application.module() {
    ...
    routing {
        ...
        get("/feed") {
            val jsonString =
                this::class.java.classLoader.getResource("feed.json").readText()
            val json = Json.parseToJsonElement(jsonString)
            call.respondText(json.toString(), ContentType.Application.Json)
        }
        get("playlist/{id}"){
            val jsonString=
                this::class.java.classLoader.getResource("playlists.json").readText()
        ...
        static (remotePath = "/"){
           ...
           static(remotePath = "songs"){
               resources(resourcePackage = "songs")
            }
        }
    }
